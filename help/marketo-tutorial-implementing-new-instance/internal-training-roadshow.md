...
Marketo Engage의 관리자로서 새로운 기술 스택 기능을 갖추고 있을 뿐만 아니라 새로운 기술 채택과 교육을 추진해야 합니다. 내부 팀들이 더 큰 규모로 활동할 수 있는 권한을 부여하는 것은 교육에 의존한다. 이를 위해서는 팀원과 가장 관련이 있는 [!DNL Marketo Engage] 기능에 대한 교육을 제공하는 방법을 배워야 합니다.
...
* *교육 모듈 개발:* 숙련도가 향상되면 마케팅 비즈니스 파트너를 위한 사용자 지정 교육 모듈을 만드는 데 주력하십시오. 아래 샘플을 사용하여 교육 커리큘럼 구성을 시작하여 Marketo Engage의 다양한 측면에 맞는 특정 모듈을 제작합니다.
...
다음은 Naomi Liu가 마케팅 비즈니스 파트너를 위해 맞춤화할 수 있도록 제안한 교육 과정 샘플입니다. 오프라인 사용자 지정을 위한 [샘플 교육 과정](assets/adobe-marketo-engage-internal-training-roadshows.xlsx){_target="blank"}을 다운로드하십시오.

| 세션 제목 | 목표 | 교육 방법 | 시간 할당 |
|--- |--- |--- |--- |
| 마케팅 운영 검토 | <ul><li>마케팅 운영 팀 업데이트 및 책임</li><li>마케팅 기술 스택 및 프로세스 개요</li><li>캠페인 생성(전체)</li><li>현재 프로세스를 검토하여 차이점 파악/해결</li></ul> | 직접 검토, 현재 프로세스 및 요구 사항에 대한 투표, Marketo Engage 진행 | 2.5시간 |
| Marketo Engage 워크스루 | <ul><li>Marketo Engage에 대한 고급 연습</li><li>캠페인 유형 및 이름 지정 규칙</li><li>Marketo Engage + CRM 통합 | 라이브 데모, 명명 규칙 작업 세션, 영업 활동 관련 게스트 세션, | 1.5시간 |
...
|  | 대화형 웨비나 | Marketo Engage 내에서 이벤트 만들기, 관리 및 전달에 대한 라이브 데모 | 1시간 |
| 대화 자동화 + 챗봇 솔루션 통합 | <ul><li>새 마케팅 채널로 채팅 활성화</li><li>Dynamic Chat - 챗봇 코드 조각 설치, 자동화된 대화 상자 만들기 및 게시</li></ul> | 대화 상자 생성 및 대상 기준 개발, 스트림 디자이너 검토 녹화된 비디오 | 1시간 |
...
* 내부 교육 모듈을 개발하려면 [샘플 교육 커리큘럼](assets/adobe-marketo-engage-internal-training-roadshows.xlsx){_target="blank"} 스프레드시트를 다운로드하십시오.
* 세션 주제에 적합한 팀을 입력합니다.

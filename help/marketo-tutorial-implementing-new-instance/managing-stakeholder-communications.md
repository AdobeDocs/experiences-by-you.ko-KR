...
## Marketo Engage 구현을 위해 이해 당사자와 소통 및 리더십 갖는 방법

### 작업 1 - 리더십 및 이해 당사자와 협력하여 Marketo Engage 기능을 목표에 맞게 연결

리더와 마케팅 및 영업 이해 관계자의 우선 순위에 맞게 구현하고 Marketo Engage이 이러한 목표를 달성하는 데 어떻게 도움이 될 것인지 교육함으로써 구현을 시작하십시오. 다음은 리더 및 이해 당사자와 협력하는 데 사용할 수 있는 몇 가지 가이드 질문입니다.
...
이전 연습에서 설명한 정보를 활용하고 Marketo Engage이 어떻게 투자 수익률(ROI)을 창출하고 이해 당사자를 위한 전략적 목표를 지원할 것인지에 대해 구체적으로 설명합니다. 다음의 초기 참여 템플릿을 사용하여 조직에 대한 Marketo Engage의 가치 제안을 강조 표시하는 매력적인 메시지를 작성하십시오.
...
좋은 소식! 이번 주부터 Marketo Engage 온보딩을 시작했습니다. 이 마케팅 자동화 기술을 MarTech 스택에 통합하면 <i>[회사 이름]</i>이 완전히 새로운 수준으로 변경됩니다. <i>[마케팅 목표]</i>에 초점을 맞춘 Marketo Engage은 크로스채널 캠페인을 통합 및 실행하여 고객을 확보, 육성, 확장 및 유지할 수 있도록 해 줍니다.
...
좋은 소식! 이번 주부터 Marketo Engagement Platform 온보딩을 시작했습니다. 이 마케팅 자동화 기술을 MarTech 스택에 통합하면 <i>[회사]</i>가 완전히 새로운 수준으로 올라가게 됩니다. <i>[판매 담당자를 더 많이, 더 높은 품질의 잠재 고객을 확보하기 위한 마케팅 활동 확장]</i>에 집중함으로써 Marketo Engage은 <i>[많은 프로세스를 자동화하고, 사용자 정의 잠재 고객/개인 점수 구조를 만들고, 잠재 고객이 영업 팀에 합류할 때 구매할 준비가 되었는지 확인하기 위해 잠재 고객을 육성할 수 있도록 허용합니다]</i>.
...
Marketo Engage 구현에 관한 환상적인 소식을 전하게 되어 기쁩니다! 협력적 노력과 전략적 접근 덕분에 Marketo Engage이 우리 조직에 제공하는 막대한 가치를 입증할 수 있는 상당한 초기 성과를 거두었습니다.
...
2. 능률적인 리드 육성 워크플로
   * 프로그램 이름: <i>[워크플로 이름]</i>
   * 목표: <i>[영업 funnel을 통한 잠재 고객 양성, 후속 작업 자동화 등 워크플로의 목적을 간략하게 설명합니다.]</i>
   * 결과:
...
이러한 성공은 타기팅된 참여와 효율적인 자동화를 추진하는 Marketo Engage의 역량과 팀의 헌신에 대한 증거입니다. 그들은 우리의 노력이 이미 우리의 마케팅 노력에 끼치고 있는 긍정적인 영향을 보여줍니다.

이러한 성과를 축하하고 Marketo Engage을 활용하여 전략적 목표를 달성할 수 있도록 계속 지원해 주시기를 부탁드립니다.
...
Marketo Engage 구현에 관한 흥미로운 소식을 전하게 되어 기쁩니다! 우리 팀은 이미 인상적인 결과를 낳은 목표 전략을 짜는 데 열심히 노력해 왔다. 이러한 초기 성공은 사용자 참여를 유도하고 리드 육성 프로세스를 간소화하는 데 있어 Marketo Engage의 힘과 잠재력을 보여 줍니다.
...
몇 주 전에 우리 팀은 Marketo Engage 플랫폼 구현 프로세스를 시작했습니다. 진행 상황에 대한 업데이트와 더불어 다음 단계 및 귀하의 팀에 대한 의미에 대해 간략히 살펴보고자 했습니다.
...
Salesforce과 Marketo Engage 통합 - <i>[완료/진행 중/시작되지 않음]</i>
첫 번째 Marketo Engage 프로그램 빌드 - <i>[완료/진행 중/시작되지 않음]</i>

[공동 작업(예: Salesforce-Marketo Engage 필드 매핑])에 도움을 주신 [영업 운영팀]에게 진심으로 감사드립니다. 앞으로의 우선 순위는 리드 채점 전략을 마무리하고 Marketo에서 리드 채점 전략을 구축하고 CRM과 Marketo Engage을 통합하는 것입니다.

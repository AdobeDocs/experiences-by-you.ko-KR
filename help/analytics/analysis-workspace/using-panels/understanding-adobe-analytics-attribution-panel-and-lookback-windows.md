...
>[!WARNING]
>
>**기여도 분석 모델**&#x200B;이(가) **마케팅 채널**&#x200B;과(와) 너무 자주 연결되어 있음을 알리는 빠른 메모에 대해 위의 이미지에서 의도적으로 *교차* ❷ 채널을 통해 대부분의 다른 ***차원***&#x200B;에 대해 **기여도 분석**&#x200B;을 수행할 수 있음을 보여 줍니다.
...
다음은 ❸ **속성 모델**&#x200B;이(가) 해당 **10명**&#x200B;에게 어떤 영향을 미칠 수 있는지에 대한 몇 가지 예입니다.
...
하지만 무엇보다도 *유용하게 사용하세요.* **속성 패널** 및 **전환 확인 기간**&#x200B;은(는) 고객과 고객의 브랜드 여정에 대한 더 깊은 이해를 얻을 수 있는 열쇠입니다.

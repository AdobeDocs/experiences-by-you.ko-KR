...
더 좋은 방법은 *신규* **날짜 범위** 및 **세그먼트**&#x200B;를 가져와서 만들었으며, &quot;너무 새로운&quot; 항목이기 때문에 적어도 다음 번에 ***Adobe Workspace***&#x200B;에 들어올 때 이러한 항목을 빠르고 쉽게 찾을 수 있다고 생각할 수 있습니다. 내 말이 맞아?
...
**Adobe**&#x200B;은(는) WE THE PEOPLE에게 #TAGS 선택 세트를 즉시 만드는 서비스를 제공했습니다. 왜냐하면.. 어디선가 시작해야 했기 때문입니다.  조금 있다가 몇 가지 주의 사항을 추가로 제공하겠지만, 내가 먼저 시연하는 것은 당신에게 가장 큰 이익을 줄 것입니다!
...
첫 번째 주의 사항: *own* 태그를 만들 때 적절한 명명 규칙을 계속 유지하면 *should*&#x200B;에 표시되는 *capitalized* 태그가 거의 모두 표시되므로 &quot;should&quot;라는 단어는 **Adobe**&#x200B;의 기본 태그된 항목이어야 합니다.  즉, 만드는 모든 태그가 **소문자**&#x200B;에 있는지 확인합니다.

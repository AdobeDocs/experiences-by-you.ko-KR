...
Funnel(폴아웃) 보고서는 여러 페이지나 이벤트를 경험하는 사용자를 표시하는 데 유용합니다. 그러나 시간에 따라 이러한 일련의 사건들의 추세를 파악할 수도 있습니다. funnel의 수준을 마우스 오른쪽 버튼으로 클릭하고 모든 터치포인트 또는 특정 터치포인트를 선 그래프로 트렌드하여 쉽게 이 작업을 수행할 수 있습니다. % 또는 원시 방문 또는 방문자 수로 이 작업을 수행할 수 있습니다.

...
### [!DNL Analytics] Workspace을 사용하여 구매 의도 신호 식별
...
원 및 완료 세그먼트를 제외하면 체크아웃 페이지에서 사이트에 다시 들어가는 사용자를 제외할 수 있습니다. 괜찮아. 하나 및 완료의 정의는 한 페이지 보기입니다. 즉, 방문자가 체크아웃 페이지에 들어가거나 새로 고침해도 방문이 진행되지 않았으므로 구매 의도가 표시되지 않습니다.
...
### [!DNL Analytics] Workspace을 사용하여 유지 의도 신호 식별

다시 말하지만, [!DNL Analytics] Workspace은 보존 의도를 식별하는 데 도움이 됩니다. 페이지, 사이트 섹션 또는 사용자 지정 세그먼트 차원을 사용하여 페이지를 분류할 수 있습니다. 구매 전환율이 낮은 페이지를 찾습니다. 이 예제에서는 온라인 체크인 및 쇼렉스(Shorex) 페이지의 전환율이 쇼핑 및 구매와 논리적으로 연결된 다른 페이지보다 상대적으로 낮습니다.
